...
const Project = () => {
  ...
  const height = useTransform(scrollYProgress, [0, 0.8], ["0%", "40%"])
  ...
  return (
    ...
    <Element name='Projects' className='relative w-full h-screen '>
      ...
      <div className="max-w-[1260px] flex items-center justify-center mx-auto absolute overflow-hidden w-full top-20 left-1/2 -translate-x-1/2 " >
        <Carousel />
      </div>
    </Element >
  )
