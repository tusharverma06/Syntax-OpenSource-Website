...
const Projectandabout = () => {
  ...
  const height = useTransform(scrollYProgress, [0, 0.18], ["0%", "100%"])
  ...
  return (
    <div className='relative w-full pt-16 min-h-[60vh] lg:min-h-screen'>
      <motion.div className='w-0 border-[4px] border-solid border-white h-screen mx-auto top-0 left-[50%] absolute -z-[1]' style={{ height, transition: transitionWhiteLine }}>
      </motion.div>
      <div className="w-full max-w-[56.125rem] h-max min-h-[30rem] bg-[rgba(43,43,43,0.26)] mx-auto rounded-[14px]  backdrop-blur-[10px]  flex flex-col items-center justify-center gap-16  py-4 px-10 z-[1]" >
