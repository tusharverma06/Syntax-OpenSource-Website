...
const Contactus = () => {
  ...
  return (
    <Element name="MainContact ">
      ...
      <div className="flex justify-center relative sm:z-auto z-10  sm:pt-0 pt-20 pb-20 font-Kanit  ">
        {" "}
        {/* Main container */}
        <div className="rounded-2xl border-[1px] border-[#eee] flex flex-col sm:px-8 px-5 justify-start lg:h-[650px] w-[400px] sm:w-full lg:w-[900px]  sm:p-16 pb-1  lg:pb-[39px] backdrop-blur-md bg-[rgba(43,43,43,0.26)] ">
          {" "}
          {/* container */}
          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col sm:flex-row sm:px-0 px-5 sm:justify-start lg:justify-start gap-4 lg:items-center sm:items-start font-Kanit  ">
             <div className="flex sm:items-center sm:flex-row flex-col  justify-start gap-4 lg:w-2/3   w-full">

              <h4 className="sm:text-3xl text-xl ">I'd like to discuss </h4>
              <div>
                <select
                  id="countries"
                  className="py-2.5 px-0 lg:w-40 text-sm sm:w-64 w-full   text-gray-900 bg-transparent border-0 border-b-2 border-white-300 dark:bg-[#1A2935] dark:placeholder-gray-400 dark:text-white  dark:focus:border-black-500 focus:outline-none "
                >
                  <option selected className="font-normal">
                    Select a Topic
                  </option>
                  <option value="I Want To Make a Agency Website">
                    Software To Cloud 
                  </option>
                  <option value="I Want To Make a E-comm Website">
                    Web Application
                  </option>
                  <option value="I Want To Make a Portfolio Website">
                    SaaS
                  </option>
                  <option value="Web & Corporate">
                    Mobile
                  </option>
                  <option value="Web & Corporate">
                    Others
              ...
              <div className="flex flex-row items-center gap-5 sm:pt-0 pt-8">
                <label className="sm:text-3xl text-xl font-Kanit lg:whitespace-nowrap">
